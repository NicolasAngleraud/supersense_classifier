...
class Parameters:
    def __init__(self, nb_epochs=300, batch_size=25, hidden_layer_size=300, patience=5, lr=0.00025, frozen=True, max_seq_length=50, window_example=10, definition_mode='definition'):
...
if __name__ == '__main__':
    ...
    with open("logs_3.txt", 'w', encoding="utf-8") as file:
